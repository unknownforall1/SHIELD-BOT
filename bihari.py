...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        bihari = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(bihari[0])
            text = "CHANGING BIO"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit(" BHAIYA JOINED SUCCESFULLY")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            bc = bihari[0]
            text = "JI AA RHA MAI WAHA"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await e.client(ImportChatInviteRequest(bc))
                await event.edit(" JI MAI JOIN HO GYA 💯🔥")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        bihari = ("".leave(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        if len(e.text) == 7:
            bc = bihari[0]
            bc = int(bc)
            text = " BHAIYA IS LEAVING THIS GROUP"
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await event.client(LeaveChannelRequest(bc))
                await event.edit(" BHAIYA MAI NIKL LIYA HU KOI KALAPE TO YAAD KRNA ")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            bc = bihari[0]
            bc = int(bc)
            text = " BHAIYA LEAVE KR RHA MAI "
            event = await e.reply(text, parse_mode=None, link_preview=None )
            try:
                await event.client(LeaveChannelRequest(bc))
                await event.edit(" BHAIYA MAI LEAVE KR LIYA 🔥")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(bihari) == 2:
            message = str(bihari[1])
            counter = int(bihari[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        bihari = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        bihariop = bihari[1:]
        if len(bihariop) == 2:
            message = str(bihariop[1])
            counter = int(bihariop[0])
            sleeptime = float(bihari[0])
            for _ in range(counter):
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.raid"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.braid"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.braid"))

async def spam(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗥𝗮𝗶𝗱\n\nCommand:\n\n.braid <count> <Username of User>\n\n.braid <count> <reply to a User>\n\nCount must be a integer."
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        bihari = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.breplyraid"))


async def _(e):
    global que
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 = 𝗥𝗲𝗽𝗹𝘆𝗥𝗮𝗶𝗱\n\nCommand:\n\n.breplyraid <Username of User>\n\n.breplyraid <reply to a User>"
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        bihari = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
        ...
        if len(e.text) > 11:
            ...
            appendable = [g]
            qeue.append(appendable)
            text = "ACTIVATING BIHAR WALA REPLY RAID"
            await e.reply(text, parse_mode=None, link_preview=None )
        elif e.reply_to_msg_id:             
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
            ...
            appendable = [g]
            qeue.append(appendable)
            text = "ACTIVATED BIHARI REPLY RAID"
            await e.reply(text, parse_mode=None, link_preview=None )
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"PING n\n {ALIVE_NAME}🔥 ALWAYS OP🔥\n`{ms}` ᴍs")
...
text = """
 JO LEGA PANGA WO HOGA NANGA PEL DO JAKE

print(text)
print("")
print("SMEX! shield Multi Spam Bot Started Sucessfully.")
